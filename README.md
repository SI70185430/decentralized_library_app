...
- `AGENTS.md` にプロジェクト固有の開発規約・設計方針・検証手順を定義し、AI Agent による出力や作業手順のばらつきを抑える。
- 各種ツールを組み合わせ、複数の AI Agent が相互に連携・レビューする体制を構築して、実装と検証を効率化する。
- Skills に再利用可能な手順やプロジェクト知識を集約し、プロンプトで毎回手動入力する情報の重複を減らす。
