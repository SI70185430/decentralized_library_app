...
| ユーザーが探したい書籍を複数の条件から検索できる機能を実装しました。 | 検索条件に一致した書籍を10件毎に一覧で表示されます。 |
...
| 書籍の書影と利用状況を確認し、利用可能な操作を選択する画面となっています。 | 貸出または予約を開始する日付を選択します。当日を選ぶと貸出、未来の日付を選ぶと予約へ分岐します。 |
...
| 返却対象の書籍、返却期限、保管場所を確認して返却処理を実行するための画面です。ユーザーの方に保管場所への返却が完了してからボタンを押してもらう想定となっています。 | 返却処理が完了した旨が表示されます。 |
